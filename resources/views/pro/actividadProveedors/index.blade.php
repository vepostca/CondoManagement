...
@section('content')
    @pageHeader('Actividad Proveedor.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('actividadProveedors') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Actividad Proveedor
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('pro.actividadProveedors.create') !!}" class="btn blue-hoki btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('pro.actividadProveedors.table')
        </div>
    </div>
@endsection
@section('scripts')
