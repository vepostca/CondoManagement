...
@section('content')
    @pageHeader('Asignación de Inmuebles y Propietarios.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('propietarioInmueblesEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Asignación de Inmuebles y Propietarios
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($propietarioInmueble, ['route' => ['com.propietarioInmuebles.update', $propietarioInmueble->id,
