...
@section('content')
    @pageHeader('Asignación de Propietario e Inmueble.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('propietarioInmuebles') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Propietarios por Inmuebles
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.propietarioInmuebles.create') !!}" class="btn white btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.propietarioInmuebles.table')
        </div>
    </div>
@endsection
@section('scripts')
