...
@section('content')
    @pageHeader('Categorías Concepto.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('categoriaConceptos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Categorías Concepto
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.categoriaConceptos.create') !!}" class="btn blue-hoki btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.categoriaConceptos.table')
        </div>
    </div>
@endsection
@section('scripts')
