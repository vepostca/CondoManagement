...
@section('content')
    @pageHeader('Tipo Contacto Telefónico.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('tipoTelefonosEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Tipo Contacto Telefónico
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($tipoTelefono, ['route' => ['com.tipoTelefonos.update', $tipoTelefono->id,
