...
@section('content')
    @pageHeader('Bancos.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('entidadBancarias') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Bancos
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.entidadBancarias.create') !!}" class="btn white btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.entidadBancarias.table')
        </div>
    </div>
@endsection
@section('scripts')
