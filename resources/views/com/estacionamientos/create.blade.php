...
@section('content')
    @pageHeader('Estacionamiento.', 'Nuevo Registro.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('estacionamientosCreate') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-thumb-tack"></i>Nuevo Estacionamiento
                </div>
                <div class="tools">
        ...
        <div class="portlet-body form">
            <div>@include('metronic-templates::common.errors')</div>
                {!! Form::open(['route' => 'com.estacionamientos.store','class' => 'horizontal-form']) !!}
                    <div class="form-body">
