...
@section('content')
    @pageHeader('Instalación.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('instalacionsEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Instalación
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($instalacion, ['route' => ['com.instalacions.update', $instalacion->id,
