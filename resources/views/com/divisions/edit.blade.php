...
@section('content')
    @pageHeader('División.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('divisionsEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de División
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($division, ['route' => ['com.divisions.update', $division->id,
