...
@section('htmlheader_title')Divisiones
@endsection

@section('content')
    @pageHeader('Divisiones.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('divisions') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Divisiones
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.divisions.create') !!}" class="btn blue-hoki btn-lg">
