...
@section('content')
    @pageHeader('Tipos de Dirección.', 'Nuevo Registro.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('tipoDireccionsCreate') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Nuevo Tipo de Dirección
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open(['route' => 'com.tipoDireccions.store','class' => 'horizontal-form']) !!}
            <div class="form-body">
