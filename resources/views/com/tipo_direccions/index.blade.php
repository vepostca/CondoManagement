...
@section('content')
    ...
    {!! Breadcrumbs::render('tipoDireccions') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Tipos de Dirección
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.tipoDireccions.create') !!}" class="btn blue-hoki btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.tipo_direccions.table')
        </div>
    </div>
@endsection