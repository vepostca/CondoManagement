...
@section('content')
    @pageHeader('Recargos.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('recargos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Recargos
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.recargos.create') !!}" class="btn blue-hoki btn-lg">
