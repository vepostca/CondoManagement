...
@section('content')
    @pageHeader('Parámetros Condominio.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {{--{!! Breadcrumbs::render('orgInfos') !!}--}}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Parámetros Condominio
            </div>
            <div class="tools">
