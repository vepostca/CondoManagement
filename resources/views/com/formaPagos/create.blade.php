...
@section('content')
    @pageHeader('Formas de Pago.', 'Nuevo Registro.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('formaPagosCreate') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-thumb-tack"></i>Nueva Forma de Pago
                </div>
                <div class="tools">
        ...
        <div class="portlet-body form">
            <div>@include('metronic-templates::common.errors')</div>
                {!! Form::open(['route' => 'com.formaPagos.store','class' => 'horizontal-form']) !!}
                    <div class="form-body">
