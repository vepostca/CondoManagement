...
@section('content')
    @pageHeader('Formas de Pago.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('formaPagos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Formas de Pago
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.formaPagos.create') !!}" class="btn blue-hoki btn-lg">
