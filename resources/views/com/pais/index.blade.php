...
@section('content')
    @pageHeader('País.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('pais') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Países
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.pais.create') !!}" class="btn blue-hoki btn-lg">
