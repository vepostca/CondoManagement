...
@section('content')
    @pageHeader('País.', 'Nuevo Registro.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('paisCreate') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Nuevo País
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open(['route' => 'com.pais.store','class' => 'horizontal-form']) !!}
            <div class="form-body">
