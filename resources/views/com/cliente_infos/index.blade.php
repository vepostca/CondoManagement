...
@section('content')
    @pageHeader('Parámetros Compañía.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {{--{!! Breadcrumbs::render('orgInfos') !!}--}}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Parámetros Compañía
            </div>
            <div class="tools">
        ...
        <div class="portlet-body">
            ...
            @include('com.cliente_infos.table')
        </div>
    </div>
@endsection
@section('scripts')
