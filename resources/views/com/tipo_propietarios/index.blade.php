...
@section('content')
    @pageHeader('Tipos de Propietario.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('tipoPropietarios') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Tipos de Propietario
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.tipoPropietarios.create') !!}" class="btn blue-hoki btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.tipo_propietarios.table')
        </div>
    </div>
@endsection
