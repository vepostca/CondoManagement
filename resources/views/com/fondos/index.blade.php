...
@section('content')
    @pageHeader('Fondos.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('fondos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Fondos
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.fondos.create') !!}" class="btn blue-hoki btn-lg">
