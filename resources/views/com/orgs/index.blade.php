...
@section('content')
    @pageHeader('Condominio.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('orgs') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Condominios
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.orgs.create') !!}" class="btn blue-hoki btn-lg">
