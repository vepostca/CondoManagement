...
@section('htmlheader_title')Comdominios
@endsection

@section('content')
    @pageHeader('Condominios.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('clientesEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Condominio
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form" style="margin-bottom: 0px">
            ...
            {!! Form::model($org, ['route' => ['com.orgs.update', $org->id], 'method' => 'patch',
