...
@section('content')
    @pageHeader('Compañías.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('clientes') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Compañías
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.clientes.create') !!}" class="btn white btn-lg">
