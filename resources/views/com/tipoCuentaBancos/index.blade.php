...
@section('content')
    @pageHeader('Tipos de Cuenta Bancaria.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('tipoCuentaBancos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Tipos de Cuenta Bancaria
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.tipoCuentaBancos.create') !!}" class="btn blue-hoki btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.tipoCuentaBancos.table')
        </div>
    </div>
@endsection
@section('scripts')
