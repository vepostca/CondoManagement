...
@section('content')
    @pageHeader('Tipos de Inmueble.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('tipoInmuebles') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Tipos de Inmueble
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.tipoInmuebles.create') !!}" class="btn blue-hoki btn-lg">
        ...
        <div class="portlet-body">
            ...
            @include('com.tipo_inmuebles.table')
        </div>
    </div>
@endsection