...
@section('content')
    @pageHeader('Tipos de Inmueble.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('tipoInmueblesEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Tipo de Inmueble
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($tipoInmueble, ['route' => ['com.tipoInmuebles.update', $tipoInmueble->id,
