...
@section('content')
    @pageHeader('Inmueble.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('inmueblesEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Inmueble
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($inmueble, ['route' => ['com.inmuebles.update', $inmueble->id,
