...
@section('htmlheader_title')Inmuebles
@endsection

@section('content')
    @pageHeader('Inmuebles.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('inmuebles') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Inmuebles
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.inmuebles.create') !!}" class="btn blue-hoki btn-lg">
