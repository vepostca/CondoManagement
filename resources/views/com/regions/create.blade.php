...
@section('content')
    @pageHeader('Región.', 'Nuevo Registro.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('regionsCreate') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Nueva Región
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open(['route' => 'com.regions.store','class' => 'horizontal-form']) !!}
            <div class="form-body">
