...
@section('content')
    @pageHeader('Regiones.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('regions') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Regiones
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.regions.create') !!}" class="btn blue-hoki btn-lg">
