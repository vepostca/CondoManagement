...
@section('content')
    @pageHeader('Conceptos.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('conceptos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Conceptos
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('com.conceptos.create') !!}" class="btn blue-hoki btn-lg">
