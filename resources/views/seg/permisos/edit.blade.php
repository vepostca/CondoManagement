...
@section('content')
    @pageHeader('Permiso.', 'Edición.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('permisosEdit') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Edición de Permiso
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::model($permiso, ['route' => ['seg.permisos.update', $permiso->id,
