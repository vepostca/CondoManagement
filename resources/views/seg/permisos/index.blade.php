...
@section('content')
    @pageHeader('Permiso.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('permisos') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Permisos
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('seg.permisos.create') !!}" class="btn blue-hoki btn-lg">
