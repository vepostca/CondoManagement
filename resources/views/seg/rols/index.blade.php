...
@section('content')
    @pageHeader('Rol.', 'Lista de Registros.', 'fa fa-angle-double-right')
    {!! Breadcrumbs::render('rols') !!}

    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-thumb-tack"></i>Lista de Roles
            </div>
            <div class="tools">
            ...
            <div class="actions">
                <a href="{!! route('seg.rols.create') !!}" class="btn blue-hoki btn-lg">
