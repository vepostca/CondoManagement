...
class CategoriaConceptoDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'com.categoriaConceptos.datatables_actions')
            ->editColumn('activo', function (CategoriaConcepto $row) {
    ...
    {
        $categoriaConceptos = CategoriaConcepto::select('com_categoria_concepto.*', 'com_cliente.nombre as nombre_cliente', 'com_org.nombre as nombre_org')
                    ->join('com_org', 'com_org.id', '=', 'com_categoria_concepto.com_org_id')
                    ->join('com_cliente', 'com_cliente.id', '=', 'com_categoria_concepto.com_cliente_id');

        return $this->applyScopes($categoriaConceptos);
    }
