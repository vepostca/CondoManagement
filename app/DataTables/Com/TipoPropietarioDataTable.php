...
class TipoPropietarioDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'com.tipo_propietarios.datatables_actions')
            ->editColumn('activo', function (TipoPropietario $row) {
    ...
    {
        //$tipoPropietarios = TipoPropietario::query();
        $tipoPropietarios = TipoPropietario::select('com_tipo_propietario.*', 'com_cliente.nombre as nombre_cliente', 'com_org.nombre as nombre_org')
            ->join('com_org', 'com_org.id', '=', 'com_tipo_propietario.com_org_id')
            ->join('com_cliente', 'com_cliente.id', '=', 'com_tipo_propietario.com_cliente_id');

        return $this->applyScopes($tipoPropietarios);
    }
