...
class TipoCuentaBancoDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'com.tipoCuentaBancos.datatables_actions')
            ->editColumn('activo', function (TipoCuentaBanco $row) {
    ...
    {
        $tipoCuentaBancos = TipoCuentaBanco::select('com_tipo_cuenta_banco.*', 'com_cliente.nombre as nombre_cliente', 'com_org.nombre as nombre_org')
                    ->join('com_org', 'com_org.id', '=', 'com_tipo_cuenta_banco.com_org_id')
                    ->join('com_cliente', 'com_cliente.id', '=', 'com_tipo_cuenta_banco.com_cliente_id');

        return $this->applyScopes($tipoCuentaBancos);
    }
