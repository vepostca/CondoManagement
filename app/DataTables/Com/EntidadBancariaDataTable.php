...
class EntidadBancariaDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'com.entidadBancarias.datatables_actions')
            ->editColumn('activo', function (EntidadBancaria $row) {
    ...
    {
        $entidadBancarias = EntidadBancaria::select('com_entidad_bancaria.*', 'com_cliente.nombre as nombre_cliente', 'com_org.nombre as nombre_org')
                    ->join('com_org', 'com_org.id', '=', 'com_entidad_bancaria.com_org_id')
                    ->join('com_cliente', 'com_cliente.id', '=', 'com_entidad_bancaria.com_cliente_id');

        return $this->applyScopes($entidadBancarias);
    }
