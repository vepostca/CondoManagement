...
class ClienteInfoDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'com.cliente_infos.datatables_actions')
            ->editColumn('activo', function (ClienteInfo $row) {
    ...
    {
        //$clienteInfos = ClienteInfo::query();
        $clienteInfos = ClienteInfo::select('com_cliente_info.*', 'com_cliente.nombre as nombre_cliente',
            ...
            ->join('com_cliente', 'com_cliente.id', '=', 'com_cliente_info.id')
            ->join('com_org', 'com_org.id', '=', 'com_cliente_info.com_org_id')
            ->join('com_moneda', 'com_moneda.id', '=', 'com_cliente_info.com_moneda_id')
            ->join('com_tipo_calculo_cuota', 'com_tipo_calculo_cuota.id', '=', 'com_cliente_info.com_tipo_calculo_cuota_id');

        return $this->applyScopes($clienteInfos);
    }
