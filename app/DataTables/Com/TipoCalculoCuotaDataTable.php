...
class TipoCalculoCuotaDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'com.tipo_calculo_cuotas.datatables_actions')
            ->editColumn('activo', function (TipoCalculoCuota $row) {
    ...
    {
        //$tipoCalculoCuotas = TipoCalculoCuota::query();
        $tipoCalculoCuotas = TipoCalculoCuota::select('com_tipo_calculo_cuota.*', 'com_cliente.nombre as nombre_cliente', 'com_org.nombre as nombre_org')
            ->join('com_org', 'com_org.id', '=', 'com_tipo_calculo_cuota.com_org_id')
            ->join('com_cliente', 'com_cliente.id', '=', 'com_tipo_calculo_cuota.com_cliente_id');

        return $this->applyScopes($tipoCalculoCuotas);
    }
